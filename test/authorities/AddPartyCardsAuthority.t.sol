...
import {AddPartyCardsAuthority} from "@party/contracts/authorities/AddPartyCardsAuthority.sol";
...
contract AddPartyCardsAuthorityTest is SetupPartyHelper {
    ...
    function test_addPartyCard_integration() public {
        ...
        calls[0] = ArbitraryCallsProposal.ArbitraryCall({
            ...
            value: 0,
            data: abi.encodeCall(
                AddPartyCardsAuthority.addPartyCards, (newPartyMembers, newPartyMemberVotingPowers, initialDelegates)
            ),
